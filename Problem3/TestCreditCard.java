...
public class TestCreditCard {
    public static void main(String[] args) {
        // Define constants for credit limit and various amounts
        ...
        // Create a Person object with name and address
        Person owner = new Person("Christie", "Diane",
                new Address("237J Harvey Hall", "Menomonie", "WI", "54751"));

        // Create a CreditCard object with the owner and a set credit limit
        CreditCard visa = new CreditCard(owner, LIMIT);

        // Display credit card owner details
        System.out.println(visa.getPersonals());
        System.out.println("Balance: " + visa.getBalance());
        System.out.println("Credit Limit: " + visa.getCreditLimit());
        System.out.println();

        // Attempt to charge the card with the first amount
        ...
        // Attempt to charge an amount exceeding the credit limit
